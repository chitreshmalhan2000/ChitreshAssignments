...
public partial class NorthWindContext : DbContext
{
    ...
    public virtual DbSet<EmployeesA> EmployeesAs { get; set; }

    public virtual DbSet<EmployeesB> EmployeesBs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=CHITRESH\\SQLEXPRESS;Initial Catalog=NORTHWND;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.TitleId).HasName("PK__Books__1062D977E1173317");
        ...
        {
            entity.HasKey(e => e.Deptno).HasName("PK__dept1__BE2C337DB465E8EB");

            entity.ToTable("dept1");
        ...
        {
            entity.HasKey(e => e.Empno).HasName("PK__empl__AF4C318A59CC5B78");
            ...
            entity.HasOne(d => d.DeptnoNavigation).WithMany(p => p.Empls)
                .HasForeignKey(d => d.Deptno)
                .HasConstraintName("fk_empl_dept");
        });
        ...
        modelBuilder.Entity<EmployeesA>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Employees_A");
        ...
        modelBuilder.Entity<EmployeesB>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Employees_B");
...
public DbSet<DbFirstEfinAsp.netcoreDemo.Models.SpainCustomerViewModel> SpainCustomerViewModel { get; set; } = default!;
}
